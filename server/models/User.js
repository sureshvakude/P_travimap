...
const UserSchema = new mongoose.Schema({
    ...
    mobileNumber: { type: String, required: true, match: [/^\d{10}$/, 'Please enter a valid 10-digit mobile number'] },
    ...
    profileBackground: { type: String, default: '/uploads/default-avatar-bg.png' },
}, { timestamps: true });
