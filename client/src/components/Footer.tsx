    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">TravelMap</h3>
            <p className="mb-4">
              Helping you discover the world's most amazing places and create unforgettable travel
              experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/travel-guides" className="hover:text-white transition">
                  Travel Guides
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; {currentYear} TravelMap. All rights reserved.
          </p>
