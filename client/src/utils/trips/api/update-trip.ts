...
export const updateTrip = async (tripId: string, tripData: Partial<user>): Promise<Trip> => {
    try {
        const response: AxiosResponse<Trip> = await apiClient.patch(
            `/api/trip/${tripId}/update/`,
            tripData
        );
